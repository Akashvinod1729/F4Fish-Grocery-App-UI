...
class _LocationScreenState extends State<LocationScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Padding(
            ...
            child: BigText(color: Colors.black87,text: "Select Location",size: 20,)),
        elevation: 0,
      ),
            ...
            Obx(() => controller.allLocationResponse.value.status ==
              ...
              height: 700,
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        spacer30,
                        /// Anime search bar
                        Shimmerwidget.rectangular(height: 40,width: 150,),
                        spacer20,
                ...
                : controller.allLocationResponse.value.status == Status.ERROR
                    ? Center(
                        child: AppText(
                          text: controller.allLocationResponse.value.error.toString(),
                        ),
                      )
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 10,),
                                  BigText(text: "Pincode",color: Colors.black,size: 20,),
                                  SizedBox(width: 10,),
                                ],
                              ),
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Icon(Icons.place_outlined,size: 15,color: Colors.deepPurple,),
                                      Spacer(
                                        flex: 1,
                                      ),
                                      BigText(color:Colors.blueGrey,text:"Use current location",size: 15,),
                                      Spacer(
                                        flex: 10,
                                      ),
                                    ],
                             ...
                             ///default locations
                              Row(
                                children: [
                                  ...
                                  BigText(text: "select city",size: 18,color: Colors.black,),
                              ...
                              ///list of pincode locations
                             SizedBox(
                                height: 100*controller.allLocationResponse.value.data!.length.toDouble(),
                                child: ListView.builder(
                                    itemCount:
                                        controller.allLocationResponse.value.data?.length,
                                    itemBuilder: (context, index) {
                                      var item =
                                          controller.allLocationResponse.value.data![index];
                                      return Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child:  ListTile(
                                            onTap: () {
                                              controller.saveLocalLocation(item);
                                              Get.back();
                                            },
                                            leading: Icon(Icons.factory_sharp,color: Colors.deepPurple.shade300,),
                                            title: AppText(
                                              text: item.name,
                                              fontSize: 18,
  ...
  Widget buildFoodShimmer()=> ListTile(
    title: Shimmerwidget.rectangular(height: 40,width: 200,),
  );
}
