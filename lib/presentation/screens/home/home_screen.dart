...
class HomeScreen extends StatelessWidget {
  ...
  final productController =  Get.put(ProductController(sl(), sl(), sl(), sl(), sl(), sl(), sl()));
                  ...
                  SliverAppBar(
                    ...
                    actions: [
                      ...
                      IconButton(
                        ...
                        icon: Icon(Pelaicons.user_light_outline,
                          size: 27,
                          color: Colors.white,),
                      ),
                      SizedBox(width: 12,),
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 10),
                                    child: Icon(
                                      Icons.search_sharp, color: Colors.black38,),
                                  ),
                                  VerticalDivider(
                                      indent: 4,
                                      endIndent: 4
                ...
                SliverToBoxAdapter(
                  ...
                  SliverToBoxAdapter(
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: BigText(text: 'Category',color: Colors.black,size: 20,),
                      ),
                    ),
                  ),
                  ...
                  SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate(
                      ...
                      childCount: controller.response.value
                  ...
                  SliverToBoxAdapter(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("Live", style: LIVEITUPFont,),
                          Text("it up", style: LIVEITUPFont,),
                          Row(
                            children: [
                              SizedBox(height: 20,),
                              Text("Crafted with ", style: LIVEITUPsmallFont,),
                              Icon(Icons.heart_broken_rounded,
                                color: roseRedColor,),
                              Text(
                                " in kozhikode ,india", style: LIVEITUPsmallFont,)
                            ],
                          )
        ...
        itemBuilder: (BuildContext context, int index) {
          return GestureDetector(
            ...
            child: popularProductContainer(
              ...
              quantityType: items[index].quantityType.first.variantName.toString(),),
          );
          /* GestureDetector(
            onTap: () {
              onItemClicked(context, items[index]);
   ...
   _locationWidget(BuildContext context) {
    return Row(
          ...
          children: [
            ...
            Icon(Icons.location_pin,size: 27,),
            ...
            Obx(() => controller.location.value == null
                ...
                : TextButton(
                    ...
                    child: BigText(text: controller.location.value?.name ?? "",size: 16,color: Colors.white,
                    )
            )),
            // Icon(Icons.edit)
          ],
