      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            AppText(
              text:
                  "Product price may change due to quantity change during shipment.\nIn this situation if the product price is higher than the amount you paid you need to pay the excess amount on the time of  or before the delivery.Other wise you will get money refund to your wallet ",
              fontSize: 16,
              fontWeight: FontWeight.w600,
              color: Color(0xff7C7C7C),
            ),
                ...
                : AppButton(
                    ...
                    onPressed: () {
                      if (authController.selectedAddress.value == null) {
                        ...
                        productController.orderProducts(OrderCreateModel(
                      ...
                      if (productController.orderCreateResponse.value.status ==
                        ...
                        Get.snackbar(
                            "ERROR",
                            productController.orderCreateResponse.value.error
                                .toString());
                      }
                    },
                  )),
