...
class GroceryItemCardWidget extends StatelessWidget {
  GroceryItemCardWidget(
      {Key? key, required this.item, required this.quantityType,required this.heroSuffix})
      : super(key: key);
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10,),
                Text(item.name,style: productCategoryHeading,maxLines: 2,),
                SizedBox(height: 20,),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                     Column(
                      crossAxisAlignment:CrossAxisAlignment.start,
                      children: [
                        Text("₹"+item.quantityType.first.sizeVariant!.price!.toStringAsFixed(2),style: priceHeading,),
                        Text("₹ "+item.quantityType.first.sizeVariant!.price!.toStringAsFixed(2),style: sellingPriceHeading,),
                      ],
                    ),
                    selectProductButton
                  ],
